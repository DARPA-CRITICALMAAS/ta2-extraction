...
UnitEnum = create_enum_from_csv('/home/ubuntu/ta2_extraction/codes/codes/minmod_units.csv', 'UnitEnum', 'unit name', 'unit aliases' )
CompoundEnum = create_enum_from_csv('/home/ubuntu/ta2_extraction/codes/codes/material_form.csv', 'CompoundEnum', 'name', 'formula' )
CommoditiesEnum =create_enum_from_csv('/home/ubuntu/ta2_extraction/codes/codes/minmod_commodities.csv', 'CommoditiesEnum', 'CommodityinMRDS', '')
CountryEnum = create_enum_from_csv('/home/ubuntu/ta2_extraction/codes/codes/country.csv', 'CountryEnum','name', 'iso3')
StateProvinceEnum = create_enum_from_csv('/home/ubuntu/ta2_extraction/codes/codes/state_or_province.csv', 'StateProvinceEnum', 'name', '')
CRSEnum = create_enum_from_csv('/home/ubuntu/ta2_extraction/codes/codes/epsg.csv', 'CRSEnum', 'name', '')
DepositEnum = create_enum_from_csv('/home/ubuntu/ta2_extraction/codes/codes/minmod_deposit_types.csv', 'DepositEnum', 'Deposit type', '')
